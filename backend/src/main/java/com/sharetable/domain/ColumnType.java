...
/**
 * Supported column types with validation rules. Used to validate cell values when updating via the
 * API.
 */
public enum ColumnType {
  ...
  /**
   * Normalizes a type string to a valid column type (string, number, date, etc.). Returns "string"
   * for null, blank, or unknown types.
   */
  ...
  /**
   * Validates a cell value against the column type. Throws IllegalArgumentException if the value is
   * invalid (e.g. non-numeric for number, invalid date format, etc.).
   */
